...
module MergeRequests
  ...
  class PostMergeService < MergeRequests::BaseService
    ...
    def close_issues(merge_request)
      return unless merge_request.target_branch == project.default_branch || (ProtectedBranch.protected?(source_project, target_branch) && !ProtectedBranch.protected?(source_project, source_branch))
