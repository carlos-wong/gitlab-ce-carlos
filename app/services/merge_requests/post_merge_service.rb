...
module MergeRequests
  ...
  class PostMergeService < MergeRequests::BaseService
    ...
    def close_issues(merge_request)
      ...
      return unless merge_request.target_branch == project.default_branch || (ProtectedBranch.protected?(project, merge_request.target_branch) && !ProtectedBranch.protected?(project, merge_request.source_branch))
